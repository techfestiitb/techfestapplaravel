                ...
                <div class="row ">
                    ...
                    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft" style="margin-right:-1%; padding-left:2.5% ;padding-right: -50%">
                        <div class="about-desc" style="margin-right: 0%; padding: 0px" >
                            ...
                            <h2 style="color: white; font-weight: bold">Cozmo Clench</h2>
                            ...
                            $team_leader_row = DB::table('tf_reg')->where(['email' => $team[0]->cozmo_team])->first();
...
{{--                                        if he is not registered--}}
                                        <a href="/competitions/cozmo/reg" class="btn btn-primary btn-learn " >Register</a>
                                    <style>

                                    </style>
                                    @endif
                                    @if($user_row->cozmo == 1 and empty($user_row->cozmo_team))
                                    <div class="dropdown ">
                                        <button class=" btn btn-primary btn-learn"><b>Team</b></button>
                                        <div class="dropdown-content">
                                            <a href="/competitions/cozmo/createteam">Create Team</a>
                                            <a href="/competitions/cozmo/jointeam">Join Team</a>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    @if(!empty($user_row->cozmo_team))
                                        @if($user_row->cozmo_team != $user_row->email )
                                        <a href="/competitions/cozmo/leaveteam" class="btn btn-primary btn-learn" >Leave current Team</a>
                                        @endif
                                            @if($user_row->cozmo_team == $user_row->email )
                                                <a href="/competitions/cozmo/dissolveteam" class="btn btn-primary btn-learn" >Dissolve the team</a>
                                                <div class="dropdown ">
                                                    ...
                                                    <div class="dropdown-content">
                                                            @if(!empty($team[0]->email) and ($team[0]->email != $team_leader_row->email))
                                                             <a href="/competitions/cozmo/remove/{{$team[0]->id}}">{{$team[0]->name}}</a>
                                                            @endif
                                                            @if(!empty($team[1]->name) and ($team[1]->email != $team_leader_row->email))
                                                             <a href="/competitions/cozmo/remove/{{$team[1]->id}}">{{$team[1]->name}}</a>
                                                            @endif
                                                            @if(!empty($team[2]->name) and ($team[2]->email != $team_leader_row->email))
                                                                <a href="/competitions/cozmo/remove/{{$team[2]->id}}">{{$team[2]->name}}</a>
                                                            @endif
                                                            @if(!empty($team[3]->name) and ($team[3]->email != $team_leader_row->email))
                                                                <a href="/competitions/cozmo/remove/{{$team[2]->id}}">{{$team[3]->name}}</a>
                                                            @endif
                                                    </div>
                                                </div>
                                            @endif
                            ...
                            @if(!empty($user_row))
                                @if($user_row->cozmo > 0 and empty($user_row->cozmo_team))
                                ...
                                <div class="" style="    border: solid 2px white;border-radius: 6px;padding: 2%;width: 95%">
                                    <p style="color: white">
                                        ...
                                        Team ID :CZ- {{$team_leader_row->cozmo_team_id}}
        ...
        <div id="text_change" class="col-md-12 animate-box scroll_inside" data-animate-effect="fadeInLeft" style="
            ...
            <p id="text_change" style="margin-bottom: 0px; color: white">
                ...
                <br>Top 5 winners from Wildcard Round will be given direct entry to Finale to be held during Techfest <br>
        <br>Top 5 teams of from each Zonal Qualifier will qualify for Finale to be held during Techfest 2019-20 (provided their score is more than a minimum cut-off score which will be decided later).<br>
                <br></p>
        </div>
