    ...
    <div class="wrap-contact100">
        <form class="contact100-form validate-form" method="post" action="/competitions/{{$form}}/createteam">
            ...
            <div class="wrap-input100 validate-input" data-validate = "Please enter your email: e@a.x">
             ...
             <div class="wrap-input100 validate-input" data-validate = "Please enter your email: e@a.x">
                <input class="input100" type="text" name="email3" placeholder="E-mail ID of member 3">
                <span class="focus-input100"></span>
            </div>
             <div class="wrap-input100 validate-input" data-validate = "Please enter your email: e@a.x">
                <input class="input100" type="text" name="email4" placeholder="E-mail ID of member 4">
                <span class="focus-input100"></span>
            </div>
