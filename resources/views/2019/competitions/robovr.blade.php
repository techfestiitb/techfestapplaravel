...
<head>
    ...
    <title>RoboVR | Techfest, IIT Bombay</title>
    ...
    <meta property="og:image" content="http://techfest.org/2019/compi/robovr.jpg"/>
    ...
    <style>
        ...
        @media (min-width:992px) {
            ...
            .mobile_hide{
                ...
                background-image: url(/2019/compi/robovr.jpg) ;
    ...
    <aside id="colorlib-aside" role="complementary" class="border js-fullheight" >
        ...
        <nav id="colorlib-main-menu" role="navigation" style="margin-top: 30vh; font-size: medium; ">
            <ul>
                ...
                <li ><a href="http://www.robovr.world">Structure</a></li>
                <li ><a href="http://www.robovr.world/RoboVR/RSA.html">FaQs</a></li>
                <li ><a href="http://www.robovr.world">Resources</a></li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft" style="margin-right:-1%; padding-left:2.5% ;padding-right: -50%">
                        <div class="about-desc" style="margin-right: 0%; padding: 0px" >
                            ...
                            <h2 style="color: white; font-weight: bold">Olympics of Robots - RoboVR</h2>
                            <hr style="color: white; border: 1px solid white">
                            <h3 style="color: white">Medals of Honor: Gold, Silver & Bronze</h3>

                            <p style=" font-size: 15px; width:90%; font-family: Lato;color: white; text-align: justify ">
                                Participants are required to build sports robots that will compete with other robots in 30+ human sports like archery, basketball, boxing, cricket, golf, tug of war & more. Each sport has a specifically defined arena and respective robot building specifications. The sports arenas are smaller versions of human arenas & robot player uses similar but smaller sports equipments used by humans. One robot can be used to play multiple sports. Know more about Olympics of Robots growing in India at
                                <a style="color: white" href="www.robovr.world"><u>www.robovr.world</u></a></p>
                            ...
                            <a href="http://robovr.world/RoboVR/RSA.html" target="_blank" class="btn btn-primary btn-learn">Problem Statement</a>
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdpbTI9O39Fcs6iOVbA66ZBQ7J8XGpb9WCjsmJ0d2zmygm7LA/viewform" target="_blank" class="btn btn-primary btn-learn" >Register</a>


                            @if(!empty($user_row))
                                @if($user_row->cozmo > 0 and empty($user_row->cozmo_team))
                                    <div class="alert alert-success">
                                        <p><strong>Hi {{$user_row->name}}, you are successfully registered for Cozmo Clench with <b>{{$user_row->email}}</b> as your Registered email id , now you must create/join a team.</strong></p>
                                    </div>
                                @endif
                                @if($user_row->cozmo > 0 and !empty($user_row->cozmo_team))
...
<script>
    function myFunction4() {
        document.getElementById("text_change").innerHTML = "<br>+91 7977360855 <br>inquiry@robovr.world <br><br> ";
        document.body.click("body");
