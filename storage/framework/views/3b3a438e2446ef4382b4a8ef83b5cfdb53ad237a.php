...
<?php echo $__env->make('2019.header.header_profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<div style="position: sticky;top: 0;background-color: white;z-index: 1;box-shadow: 0px 10px 10px 1px rgba(0, 0, 0, .2)">
    <div class="row" >
        ...
        <hr>
        <div class="col-8">
            <p style="font-size: 1.4em;margin-top: 5px;margin-bottom: 0;"><?php echo $user_row->name; ?></p>
...
<div class="row popup">
    <?php $__currentLoopData = $user_image; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
        <div class="col-4 image_grid" style="background-image: url('<?php echo $user_image->image; ?>'); max-height: 33.33vw;background-size: cover;background-position: center;">
            <img  src="<?php echo $user_image->image; ?>" alt="" style="opacity: 0; width: 100%">
        </div>
...
<div style="position: fixed;bottom: 20px;right: 20px;">
    <form class="" id="image_form" enctype="multipart/form-data" action="<?php echo e(route('image_upload')); ?>"  method="post">
        <?php echo e(csrf_field()); ?>
...
</html><?php /**PATH /var/app/current/blog/resources/views/2019/profile/profileGet.blade.php ENDPATH**/ ?>