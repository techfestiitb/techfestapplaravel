        ...
        <div style="padding-top: 0.5em;">
                <div class="row" style="display: flex;padding: 0% 5%;height: 25vw;">
                    <div class="col-8" style="    overflow: scroll;height: 100%;">
                        <h5 style="margin-bottom: 0;"><?php echo $lectures_row->name; ?></h5>
                        <p style="font-size: 13px"><i><?php echo $lectures_row->designation; ?></i> </p>
                        <p style="font-size: 11px"><?php echo $lectures_row->description; ?></p>
                    </div>
                    <div class="col-4" style="background-image: url('http://techfest.org<?php echo $lectures_row->image; ?>');background-size: cover;background-position: center;border-radius: 20px">
                    </div>
                </div>
            <div class="row" style="display: flex;padding: 0% 5%;">
                <div class="col-8">
                    <p style="font-size: 10px"><?php echo $lectures_row->time_venue; ?></p>
                </div>
...
<?php /**PATH /var/app/current/blog/resources/views/2019/lectures/lectures.blade.php ENDPATH**/ ?>