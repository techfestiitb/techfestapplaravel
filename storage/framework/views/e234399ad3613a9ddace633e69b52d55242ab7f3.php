...
<body>
<div >
    <form action="/profile/image_upload" class="dropzone" method="post">
...
<div style="margin: 20px;">
    ...
    <ol>
        ...
        <li style="color: red"><b>Duplicate or false images will be heavily penalized!</b></li>
        ...
        <li>The image file should be <b>less than 2MB</b> in size.</li>
        <li>The Techfest name and logo should be clearly visible in the photograph.</li>
    </ol>
</div>

<div>
    <a href="/dashboard" class="w3-button w3-green">Go back to Dashboard</a>
</div>


<script src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
<script src="/2019/ca/js/dropzone.js"></script>

</body>
</html><?php /**PATH /var/app/current/blog/resources/views/2019/ca/img_upload.blade.php ENDPATH**/ ?>